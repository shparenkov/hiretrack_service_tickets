...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .top-link { border: 1px solid #7ea3c9; border-radius: 3px; padding: 6px 12px; color: #fff; background: #173f72; text-decoration: none; white-space: nowrap; }
    .top-link:hover { background: #3472b2; }
