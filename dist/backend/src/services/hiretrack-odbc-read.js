...
exports.runHiretrackRead = runHiretrackRead;
const child_process_1 = require("child_process");
const path_1 = __importDefault(require("path"));
function resolveBridgePath() {
    return path_1.default.resolve(process.cwd(), 'backend', 'python', 'hiretrack_read.py');
}
function runHiretrackRead(operation, payload) {
